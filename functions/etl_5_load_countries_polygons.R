...
load_countries_polygons <- function(force_download=FALSE, force_format=FALSE){
  ...
  if(force_download){
    ...
    unzip(zipfile = '../data/temp-polygons/CNTR_RG_60M_2016_4326.shp.zip', exdir = '../data/polygons/')
  ...
  if(force_format | force_download){
    ...
    countries_poly <- readOGR(dsn=path.expand("../data/polygons/"), layer = 'CNTR_RG_60M_2016_4326')
